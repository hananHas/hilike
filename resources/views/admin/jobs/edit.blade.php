    ...
    <div class="card-body">
        <form class="form-horizontal" action="{{ route('jobs.update',$job->id) }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="name" placeholder="{{ __('English name') }}" value="{{ $job->name }}">
                    @if ($errors->has('name'))
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="ar_name" placeholder="{{ __('Arabic name') }}" value="@if(isset($job->translate)){{$job->translate->name}}@endif">
