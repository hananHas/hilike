...
@push('scripts')
    ...
    <script>
        $(".open_edit_modal").click(function () {
            var id = $(this).data('id');
            $('#modal_title_edit').html('Edit Looking for');
            $('#label_edit').html('Looking for');
            $('#form_edit_text').attr('action','{{url("/update/looking_for/")}}'+'/'+ id);
