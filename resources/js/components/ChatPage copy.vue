    ...
    <div class="d-flex chat-container">
      <div class="col-md-4 border-right px-0">
        <ul class="list-group list-group-flush">
          <li class="list-group-item user-list-item" :class="{'active': activeChat ? activeChat.id === chat.id : null}" v-for="chat in chats" :key="chat.id">
            <a href="#" @click.prevent="selectChat(chat.id)" class="nav-link">
              <p class="card-text">{{chat.nickname}}</p>
            </a>
          </li>
        </ul>
      </div>
